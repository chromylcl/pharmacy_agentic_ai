...
export default function AdminPortal() {
  ...
  const stats = [
    { label: 'Latency', value: '1.24s', icon: <Zap size={18} />, color: 'text-amber-500', bg: 'bg-amber-500/10' },
    { label: 'Active Users', value: '84', icon: <Users size={18} />, color: 'text-blue-500', bg: 'bg-blue-500/10' },
    { label: 'Integrity', value: '99.9%', icon: <ShieldAlert size={18} />, color: 'text-rose-500', bg: 'bg-rose-500/10' }
  ];
