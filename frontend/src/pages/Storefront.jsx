...
export default function Storefront() {
  const { refreshTrigger } = usePharmacy();
        ...
        <div className="flex items-center gap-4 overflow-x-auto pb-6 scrollbar-hide border-b border-white/40">
          {categories.map(cat => (
            <button
              ...
              className={`px-8 py-3 rounded-full text-xs font-black uppercase tracking-widest transition-all duration-500 whitespace-nowrap ${activeCategory === cat
