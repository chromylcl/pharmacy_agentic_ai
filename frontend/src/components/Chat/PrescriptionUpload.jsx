...
const PrescriptionUpload = ({ isOpen, onClose, onUploadComplete, medicineName }) => {
  ...
  const uploadToBackend = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/upload-prescription/${userId}/${medName}`, {
        method: 'POST',
        body: formData,
      });
